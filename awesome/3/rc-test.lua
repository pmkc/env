...
--        screen = 1,
--        slave = true,
--        spawn = spawn_clients and terminal .. ' -e tm -t tmux',
--    },
--    home = {
--        layout = awful.layout.suit.tile.bottom,
--        mwfact = 0.65,
...
--        init = true,
--        position = 7,
--        spawn = spawn_clients and browser .. " --user-data-dir=" ..
--            home .. "/.config/google-chrome/Personal",
--    },
--    web = {
--        layout = awful.layout.suit.tile.bottom,
--        mwfact = 0.65,
...
--        init = true,
--        position = 1,
--        spawn = spawn_clients and browser
--    },
--    dev = {
--        layout = awful.layout.suit.tile.bottom,
--        mwfact = 0.65,
